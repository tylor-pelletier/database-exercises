...
-- TRUNCATE books;
--
-- --Insert book information to the books table
-- INSERT INTO books (title, author, date_published, description, bestseller_weeks)
-- VALUES
-- ("Harry Potter and the Sorcerer's Stone", "J.K. Rowling", "1997-06-26", "This book is about wizards", "10")
-- ("The Hobit", "J.R.R. Tolkien", "1937-07-21", "This book is about Hobbits", "7")
-- ("1984", "George Orwell","1960-07-11", "This book is about Big Brother", "5")
--
-- -- Change the second book's author to Han
-- SELECT * FROM books
-- WHERE id = 1
--
-- UPDATE books
...
-- WHERE id = 1
--
-- -- Change the first book's title to Star Wars and author to George Lucas
-- SELECT * FROM books
-- WHERE id = 2\G
--
-- UPDATE books
-- SET author = 'George Lucas', title = 'Star Wars'
-- WHERE id = 2\G
--
-- -- Change the author of the books after the first book to George
-- SELECT * FROM books
-- WHERE id > 1\G
--
-- UPDATE books
...
--
-- -- Be safe about deleting and make a SELECT statement before
-- -- First:
